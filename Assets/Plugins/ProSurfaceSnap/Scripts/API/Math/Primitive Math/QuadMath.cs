...
namespace PSS
{
    ...
    public static class QuadMath
    {
        ...
        public static OOBB Calc3DQuadOOBB(Vector3 quadCenter, Vector2 quadSize, Quaternion quadRotation, QuadEpsilon epsilon = new QuadEpsilon())
        {
            Vector3 size = quadSize + epsilon.SizeEps;
            size.z = epsilon.ExtrudeEps * 2.0f;
            return new OOBB(quadCenter, size, quadRotation);
        }
